...
export class LAppDelegate {
  ...
  public setCanvasContainer(container: HTMLElement): void {
  ...
  private initializeSubdelegates(): void {
    ...
    for (let i = 0; i < LAppDefine.CanvasNum; i++) {
      ...
      canvas.style.background = 'transparent'; // not working yet
      canvas.style.backgroundColor = 'transparent';
      
      // Add canvas to specified container or fallback to document.body
      const container = this._canvasContainer || document.body;
